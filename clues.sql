...
SELECT language FROM countrylanguages JOIN countries ON countrylanguages.countrycode = countries.code WHERE countries.code = 'VAT';
...
AND countrylanguages.countrycode IN (
...
AND countries.name != cities.name;
